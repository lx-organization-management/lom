...
public class PurchasePaymentDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "jp.luxa.lom.dbflute.exentity.PurchasePayment"; }
    public String getConditionBeanTypeName() { return "jp.luxa.lom.dbflute.cbean.PurchasePaymentCB"; }
    public String getBehaviorTypeName() { return "jp.luxa.lom.dbflute.exbhv.PurchasePaymentBhv"; }
