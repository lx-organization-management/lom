...
public class PurchaseDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "jp.luxa.lom.dbflute.exentity.Purchase"; }
    public String getConditionBeanTypeName() { return "jp.luxa.lom.dbflute.cbean.PurchaseCB"; }
    public String getBehaviorTypeName() { return "jp.luxa.lom.dbflute.exbhv.PurchaseBhv"; }
