...
import jp.luxa.lom.dbflute.allcommon.DBCurrent;
import jp.luxa.lom.mylasta.appcls.AppCDef;
 ...
 * @author jflute
 */
public class LomListedClassificationProvider extends TypicalListedClassificationProvider { // basically for HTML response
