...
public class MemberSecurityDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "jp.luxa.lom.dbflute.exentity.MemberSecurity"; }
    public String getConditionBeanTypeName() { return "jp.luxa.lom.dbflute.cbean.MemberSecurityCB"; }
    public String getBehaviorTypeName() { return "jp.luxa.lom.dbflute.exbhv.MemberSecurityBhv"; }
