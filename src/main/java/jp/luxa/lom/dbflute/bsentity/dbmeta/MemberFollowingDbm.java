...
public class MemberFollowingDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "jp.luxa.lom.dbflute.exentity.MemberFollowing"; }
    public String getConditionBeanTypeName() { return "jp.luxa.lom.dbflute.cbean.MemberFollowingCB"; }
    public String getBehaviorTypeName() { return "jp.luxa.lom.dbflute.exbhv.MemberFollowingBhv"; }
