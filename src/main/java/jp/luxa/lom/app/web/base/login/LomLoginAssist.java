...
import jp.luxa.lom.dbflute.cbean.MemberCB;
import jp.luxa.lom.dbflute.exbhv.MemberBhv;
import jp.luxa.lom.dbflute.exbhv.MemberLoginBhv;
import jp.luxa.lom.dbflute.exentity.Member;
import jp.luxa.lom.dbflute.exentity.MemberLogin;
 ...
 * @author jflute
 */
public class LomLoginAssist extends TypicalLoginAssist<Integer, LomUserBean, Member> // #change_it also UserBean
    ...
    //                                                                       =============
    @Override
    protected LomUserBean createUserBean(Member userEntity) {
        return new LomUserBean(userEntity);
    }

    @Override
    protected OptionalThing<String> getCookieRememberMeKey() {
        return OptionalThing.of(config.getCookieRememberMeLomKey());
    }
    ...
    @Override
    protected void saveLoginHistory(Member member, LomUserBean userBean, LoginSpecifiedOption option) {
        asyncManager.async(() -> {
    ...
    //                                                                      ==============
    @Override
    protected Class<LomUserBean> getUserBeanType() {
        return LomUserBean.class;
    }
