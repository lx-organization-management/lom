...
public class RegionDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "jp.luxa.lom.dbflute.exentity.Region"; }
    public String getConditionBeanTypeName() { return "jp.luxa.lom.dbflute.cbean.RegionCB"; }
    public String getBehaviorTypeName() { return "jp.luxa.lom.dbflute.exbhv.RegionBhv"; }
