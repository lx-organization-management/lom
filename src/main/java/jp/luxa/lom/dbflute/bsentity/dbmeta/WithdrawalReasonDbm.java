...
public class WithdrawalReasonDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "jp.luxa.lom.dbflute.exentity.WithdrawalReason"; }
    public String getConditionBeanTypeName() { return "jp.luxa.lom.dbflute.cbean.WithdrawalReasonCB"; }
    public String getBehaviorTypeName() { return "jp.luxa.lom.dbflute.exbhv.WithdrawalReasonBhv"; }
