...
public class MemberAddressDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "jp.luxa.lom.dbflute.exentity.MemberAddress"; }
    public String getConditionBeanTypeName() { return "jp.luxa.lom.dbflute.cbean.MemberAddressCB"; }
    public String getBehaviorTypeName() { return "jp.luxa.lom.dbflute.exbhv.MemberAddressBhv"; }
