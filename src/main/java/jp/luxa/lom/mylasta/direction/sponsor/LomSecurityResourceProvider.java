 ...
 * @author jflute
 */
public class LomSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public LomSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
