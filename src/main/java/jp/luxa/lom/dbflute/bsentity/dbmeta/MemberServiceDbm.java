...
public class MemberServiceDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "jp.luxa.lom.dbflute.exentity.MemberService"; }
    public String getConditionBeanTypeName() { return "jp.luxa.lom.dbflute.cbean.MemberServiceCB"; }
    public String getBehaviorTypeName() { return "jp.luxa.lom.dbflute.exbhv.MemberServiceBhv"; }
