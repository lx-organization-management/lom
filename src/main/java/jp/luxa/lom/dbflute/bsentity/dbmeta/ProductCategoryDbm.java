...
public class ProductCategoryDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "jp.luxa.lom.dbflute.exentity.ProductCategory"; }
    public String getConditionBeanTypeName() { return "jp.luxa.lom.dbflute.cbean.ProductCategoryCB"; }
    public String getBehaviorTypeName() { return "jp.luxa.lom.dbflute.exbhv.ProductCategoryBhv"; }
