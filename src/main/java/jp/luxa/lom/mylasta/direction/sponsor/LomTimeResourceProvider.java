 ...
 * @author jflute
 */
public class LomTimeResourceProvider extends TypicalTimeResourceProvider {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public LomTimeResourceProvider(LomConfig config) {
        this.config = config;
    }
    ...
    protected TimeZone getCentralTimeZone() {
        return LomUserTimeZoneProcessProvider.centralTimeZone;
    }
