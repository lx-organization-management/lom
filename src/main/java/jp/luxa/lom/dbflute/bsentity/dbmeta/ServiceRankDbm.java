...
public class ServiceRankDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "jp.luxa.lom.dbflute.exentity.ServiceRank"; }
    public String getConditionBeanTypeName() { return "jp.luxa.lom.dbflute.cbean.ServiceRankCB"; }
    public String getBehaviorTypeName() { return "jp.luxa.lom.dbflute.exbhv.ServiceRankBhv"; }
