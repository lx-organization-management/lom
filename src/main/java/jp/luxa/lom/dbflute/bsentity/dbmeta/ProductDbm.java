...
public class ProductDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "jp.luxa.lom.dbflute.exentity.Product"; }
    public String getConditionBeanTypeName() { return "jp.luxa.lom.dbflute.cbean.ProductCB"; }
    public String getBehaviorTypeName() { return "jp.luxa.lom.dbflute.exbhv.ProductBhv"; }
