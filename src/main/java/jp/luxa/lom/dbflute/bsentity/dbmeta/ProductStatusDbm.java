...
public class ProductStatusDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "jp.luxa.lom.dbflute.exentity.ProductStatus"; }
    public String getConditionBeanTypeName() { return "jp.luxa.lom.dbflute.cbean.ProductStatusCB"; }
    public String getBehaviorTypeName() { return "jp.luxa.lom.dbflute.exbhv.ProductStatusBhv"; }
